CREATE OR REPLACE TRIGGER ACCOUNT_ESP_UPDATE
	AFTER UPDATE ON ACCOUNT_ESP
	FOR EACH ROW
...
-- Trigger an Account Change to handle any Account ESP Name dependency.
		UPDATE ACCOUNT
		SET ENTRY_DATE = ENTRY_DATE
		WHERE ACCOUNT_ID = :new.ACCOUNT_ID;
	END IF;

END ACCOUNT_ESP_UPDATE;
/ 
