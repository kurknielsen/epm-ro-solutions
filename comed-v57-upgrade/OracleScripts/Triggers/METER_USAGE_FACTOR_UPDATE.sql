create or replace trigger METER_USAGE_FACTOR_UPDATE
  BEFORE INSERT OR UPDATE ON METER_USAGE_FACTOR
  FOR EACH ROW
DECLARE

BEGIN

    IF (:OLD.CASE_ID IS NULL OR :OLD.METER_ID IS NULL OR :OLD.BEGIN_DATE IS NULL) -- INSERT
      OR (:OLD.CASE_ID <> :NEW.CASE_ID
            OR :OLD.METER_ID <> :NEW.METER_ID
