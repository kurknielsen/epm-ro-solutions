...
DECLARE
	...
	BEGIN
        ...
        IF v_FORMAT_ID > 0 THEN 
            BEGIN
                EM.PUT_CONDITIONAL_FORMAT_ITEM(v_FORMAT_ID, p_ITEM_NUMBER, p_COLOR_WHEN_FORMULA, p_FOREGROUND_COLOR, p_BACKGROUND_COLOR, p_IS_BOLD, p_IS_ITALIC, p_IS_STRIKE_THROUGH, p_IS_UNDERLINE, v_STATUS);
...
BEGIN -- MAIN
    ...
    -- Load EveryOther Conditional format 
    PUT_CONDITIONAL_FORMAT_ITEM('EveryOther', 1, 'X%2=1', -16777216, -3342388);
