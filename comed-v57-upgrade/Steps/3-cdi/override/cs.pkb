...
-- Allow The Pool Of Record Lookup Based On Enrollment To Be Overriden With The Specified Pool Id --
...
BEGIN
	...
	ELSE
-- Begin Implementation Override --
      v_POOL_ID := CASE WHEN p_POOL_ID IS NOT NULL THEN p_POOL_ID ELSE GET_POOL_OF_RECORD(v_ACCOUNT_SERVICE.ACCOUNT_ID, v_PROVIDER_SERVICE.ESP_ID, v_SERVICE_DATE, v_ACCOUNT_SERVICE.AGGREGATE_ID > 0) END;
-- End Implementation Override --
 	END IF;
...
-- Begin Implementation Override --
   -- v_SERVICE_STATE.IS_UFE_PARTICIPANT := 0;
   v_SERVICE_STATE.IS_UFE_PARTICIPANT := GET_ACCOUNT_IS_UFE_PARTICIPANT(v_ACCOUNT_SERVICE.Account_Id);
-- End Implementation Override --
