...
CREATE OR REPLACE PACKAGE BODY soap_api AS
   ...
   p_env := '<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:web="http://webservices.nm.scgo.com">
   <soapenv:Header/>
   <soapenv:Body>
      <web:exportData soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
         <cluster xsi:type="xsd:string">'||p_cluster||'</cluster>
         <participant xsi:type="xsd:string">'||p_ptcpt_cd||'</participant>
         <fileName xsi:type="xsd:string">sample.xml</fileName>
         <fileData xsi:type="xsd:string"><![CDATA[
   <a> some text </a>
]]></fileData>
         <processName xsi:type="xsd:string">'||p_process||'</processName>
         <optionalParams xsi:type="xsd:string"></optionalParams>
      </web:exportData>
   </soapenv:Body>
</soapenv:Envelope>
';               
   ...
   BEGIN
      generate_envelope(p_request, l_envelope ,p_cluster,p_ptcpt_cd,p_process ,p_payload);
      ...
      utl_http.set_authentication( l_http_request, p_username, p_password, 'Basic' );
