...
BEGIN
   ...
   FROM NON_COMPETITIVE X
      JOIN SERVICE_OBLIGATION_LOAD L ON L.SERVICE_OBLIGATION_ID = X.SERVICE_OBLIGATION_ID AND L.SERVICE_CODE = p_SCHEDULE_TYPE AND L.LOAD_DATE BETWEEN v_BEGIN_DATE AND v_END_DATE
