CREATE OR REPLACE PACKAGE MM_PJM AS

-- PJM Exchange package
...
--@@Begin Implementation Override--
   c_EDC_NAME              CONSTANT VARCHAR2(32) := 'BGE';
   c_COMPANY_NAME          CONSTANT VARCHAR2(32) := 'BC'; --KN Changed from "BG"to "BC" (10/2020)
   c_EXTERNAL_ACCOUNT_NAME CONSTANT VARCHAR2(32) := 'BG';
