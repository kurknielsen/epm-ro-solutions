...
PROCEDURE PARSE_DERATION_FACTORS(p_CONTAINER IN CLOB, p_STATUS OUT NUMBER, p_MESSAGE OUT VARCHAR2);
...
g_ET_LOAD_LOSSES_MSRS CONSTANT VARCHAR2(64) := 'Load InSchedule With and Without Losses';
