...
PROCEDURE RUN_JOB_NOW(p_JOB_NAME IN VARCHAR2, p_MESSAGE OUT VARCHAR2);

PROCEDURE RUN_JOB_AT(p_FILTER_JOB_NAME IN VARCHAR2, p_FILTER_RUN_AT DATE, p_MESSAGE OUT VARCHAR2);

PROCEDURE GET_JOB_RUN_AT_DATE_TIME(p_JOB_NAME IN VARCHAR2, p_CURSOR OUT GA.REFCURSOR);
...
--PROCEDURE GET_JOB_SCHEDULE(p_JOB_NAME IN VARCHAR2, p_CURSOR OUT GA.REFCURSOR);
PROCEDURE GET_JOB_SCHEDULE(p_CURSOR OUT GA.REFCURSOR);
