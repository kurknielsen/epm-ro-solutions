...
BEGIN
    ...
    CASE UPPER(v_MKT)
        WHEN 'SEM' THEN
            NULL; -- MM_SEM.GET_AFFECTED_DATE_RANGE(p_TRANSACTION_ID, p_CUT_DATE, p_IS_SUB_DAILY, p_BEGIN_DATE, p_END_DATE); --@@Implementation Override--
		ELSE
...
BEGIN
    ...
    CASE UPPER(v_MKT)
        WHEN 'SEM' THEN
			RETURN TRUE; --MM_SEM.TRAIT_AFFECTS_STATUS(p_TRANSACTION_ID, p_TRAIT_GROUP_ID, p_TRAIT_INDEX);--@@Implementation Override--
		ELSE
			-- default is yes
			RETURN TRUE;
		END CASE;
