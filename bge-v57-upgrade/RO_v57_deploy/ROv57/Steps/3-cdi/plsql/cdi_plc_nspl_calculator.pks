...
PROCEDURE SUBMIT_BACKGROUND_JOB(p_TASK_NAME IN VARCHAR2, p_ANCILLARY_SERVICE_ID IN NUMBER, p_PLAN_YEAR IN VARCHAR2);
...
PROCEDURE CUT_PLC_NSPL_PEAK(p_ENTRY_ROWID IN VARCHAR2);
