...
v_PARENT_OBJECT_ID := v_OBJECT_ID;
   -------------------------------------
   --   UNAPPROVED_EXT_BILATERALS
   -------------------------------------
      SO.PUT_SYSTEM_OBJECT_FOR_SCRIPT(v_PARENT_OBJECT_ID, 'UNAPPROVED_EXT_BILATERALS', 'Report', 'Unapproved External Bilaterals', '', 6, 0, '401~MM.UNAPPROVED_EXT_BILATERALS', v_OBJECT_ID);
      -------------------------------------
      --   UNAPPROVED_EXT_BILATERALS_Grid
      -------------------------------------
      <<L1>>
      DECLARE
      ...
      BEGIN
         SO.PUT_SYSTEM_OBJECT_FOR_SCRIPT(v_PARENT_OBJECT_ID, 'UNAPPROVED_EXT_BILATERALS_Grid', 'Grid', '', '', 0, 0, '', v_OBJECT_ID);
