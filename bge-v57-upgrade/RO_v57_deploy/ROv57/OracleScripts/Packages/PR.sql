CREATE OR REPLACE PACKAGE PR AS
...
g_DOMAIN_NAME VARCHAR(16) := 'PRODUCT';

c_FML_ID_IS_ENTITY CONSTANT PLS_INTEGER := 0;
c_FML_ID_IS_REALM  CONSTANT PLS_INTEGER := 1;
c_FML_ID_IS_GROUP  CONSTANT PLS_INTEGER := 2;

c_TOU_RATE_STRUCTURE CONSTANT VARCHAR2(12) := 'TIME OF USE';
c_FLAT_RATE_STRUCTURE CONSTANT VARCHAR2(12) := 'FLAT';
c_FORMULA_RATE_STRUCTURE CONSTANT VARCHAR2(12) := 'FORMULA';
END PR;
/
