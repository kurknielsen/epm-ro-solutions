create or replace package MEX_ETAG is
...
/
create or replace package body MEX_ETAG is

-- ETAG package.

g_PACKAGE_NAME CONSTANT VARCHAR2(8) := 'MEX_ETAG';
...
BEGIN
    ...
    --Uncomment following to test from xml_trace table
	/*SELECT x.clob_data
    INTO v_CLOB
...
BEGIN
	...
	MEX_HTTP.MESSAGE_QUEUE_START(v_CREDENTIALS, 'etag', p_MESSAGE, 'etag', 'download');
